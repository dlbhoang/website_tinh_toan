export const topNavItems = [
  { id: 'ky-thuat', label: 'Kỹ thuật - Công nghệ', page: 'ky-thuat', children: [] },
  { id: 'dieu-khoan', label: 'Điều khoản dịch vụ', page: 'dieu-khoan', children: [] },
  {
    id: '3pha-1td', label: 'Trung tâm học tập 3 pha, 1 Tốc độ', page: null,
    children: [
      { groupLabel: 'Kỹ thuật dây quấn động cơ cảm ứng 3 pha, 1 tốc độ.', items: [
      ...
      { groupLabel: 'Phương pháp xây dựng sơ đồ khai triển 3 pha 1 tốc độ, số nguyên.', items: [
      ...
      { groupLabel: 'Phương pháp xây dựng sơ đồ khai triển 3 pha 1 tốc độ, số tối giản.', items: [
  ...
  {
    id: '3pha-2td', label: 'Trung tâm học tập 3 pha, 2 Tốc độ', page: null,
    children: [
      { groupLabel: 'Kỹ thuật dây quấn động cơ cảm ứng 3 pha, 2 tốc độ.', items: [
      ...
      { groupLabel: 'Phương pháp xây dựng sơ đồ khai triển 3 pha, 2 tốc độ, theo (Robert Dahlander)', items: [
  ...
  {
    id: '1pha', label: 'Trung tâm học tập 1 pha', page: null,
    children: [
      { groupLabel: 'Kỹ thuật dây quấn động cơ cảm ứng 1 pha.', items: [
      ...
      { groupLabel: 'Phương pháp xây dựng sơ đồ khai triển động cơ 1 pha.', items: [
...
export const bottomNavItems = [
  {
    id: 'tt-3pha-1td', label: 'Tính toán dữ liệu 3 pha, 1 tốc độ.',
    children: [
      { groupLabel: 'Tính toán dữ liệu 3 pha, số nguyên:', items: [
        { label: 'Tính toán dữ liệu 3 pha 1 lớp.', page: 'tt-3pha-sn-1lop' },
        { label: 'Tính toán dữ liệu 3 pha 2 lớp.', page: 'tt-3pha-sn-2lop' },
        { label: 'Hướng dẫn tính toán dữ liệu.', page: 'tt-3pha-sn-hd' },
      ]},
      { groupLabel: 'Tính toán dữ liệu 3 pha, phân số tối giản:', items: [
        { label: 'Tính toán dữ liệu 3 pha 1 lớp.', page: 'tt-3pha-tg-1lop' },
        { label: 'Tính toán dữ liệu 3 pha 2 lớp.', page: 'tt-3pha-tg-2lop' },
        { label: 'Hướng dẫn tính toán dữ liệu.', page: 'tt-3pha-tg-hd' },
      ]},
    ],
  },
  {
    id: 'tt-3pha-2td', label: 'Tính toán dữ liệu 3 pha, 2 tốc độ.',
    children: [
      { groupLabel: 'Tính toán dữ liệu 3 pha, 2 tốc độ, Theo (Robert Dahlander).', items: [
        { label: 'Tính toán dữ liệu đổi tốc độ momen không đổi (n=var; T=const): (2Y/∆).', page: 'tt-2td-th1' },
        { label: 'Tính toán dữ liệu đổi tốc độ Công suất không đổi (n=var; P=const): (∆/2Y).', page: 'tt-2td-th2' },
        { label: 'Tính toán dữ liệu đổi tốc độ công suất và momen thay đổi (n=var; P=var, T=var): (2Y/Y).', page: 'tt-2td-th3' },
        { label: 'Hướng dẫn tính toán dữ liệu.', page: 'tt-2td-hd' },
      ]},
    ],
  },
  {
    id: 'tt-1pha', label: 'Tính toán dữ liệu 1 pha.',
    children: [
      { groupLabel: 'Pha làm việc và pha khởi động dây quấn sin:', items: [
        { label: 'Tính toán dữ liệu dây quấn sin.', page: 'tt-1pha-sin' },
        { label: 'Hướng dẫn tính toán dữ liệu dây quấn sin.', page: 'tt-1pha-sin-hd' },
      ]},
      { groupLabel: 'Phân bố QA = 2.QB:', items: [
      ...
      { groupLabel: 'Phân bố QA = 3.QB:', items: [
